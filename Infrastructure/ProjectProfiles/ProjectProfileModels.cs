...
internal sealed class ProjectProfileDb
{
	...
	[JsonIgnore]
	public HashSet<string> InvalidProfilePaths { get; set; } = new(PathComparer.Default);
	[JsonIgnore]
	public bool ContainsInvalidEntries { get; set; }
}
internal sealed class PersistedProjectProfile
{
	...
	public Dictionary<string, bool> RootFolderStates { get; set; } =
	...
	public int SelectedPathsSemanticsVersion { get; set; }
