...
remain valid clone sources and use the managed cache, but are never added to
repository history. A `file://` source is refused. Later invocations reuse the complete
