...
Generated CSV files always use the English `Type` header; capture and validation also accept the localized export form `Type (...)`, so a Partner Center export made in any portal language stays compatible without edits.
