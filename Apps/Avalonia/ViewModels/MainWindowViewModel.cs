...
public sealed partial class MainWindowViewModel : ViewModelBase, IDisposable
{
    ...
    public string MenuMcpClaudeCode { get; private set; } = string.Empty;
    public string MenuMcpCodex { get; private set; } = string.Empty;
    public string MenuMcpJson { get; private set; } = string.Empty;
    ...
    public void UpdateLocalization()
    {
        ...
        MenuMcpClaudeCode = _localization["Menu.Mcp.ClaudeCode"];
        MenuMcpCodex = _localization["Menu.Mcp.Codex"];
        MenuMcpJson = _localization["Menu.Mcp.Json"];
        ...
        RaisePropertyChanged(nameof(MenuMcpClaudeCode));
        RaisePropertyChanged(nameof(MenuMcpCodex));
        RaisePropertyChanged(nameof(MenuMcpJson));
