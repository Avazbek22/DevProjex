...
public sealed class ProjectProfileSmartGitDotRoundTripIntegrationTests
{
		...
		string artifactExtension)
	{
		...
		AddAmbiguousArtifactEvidence(project, markerPath);
		project.CreateFile(".idea/workspace.xml", "<project />\n");
	...
	private static void AddAmbiguousArtifactEvidence(TemporaryDirectory project, string markerPath)
	{
		switch (markerPath)
		{
			case "go.mod":
				project.CreateFile("vendor/modules.txt", "# generated by go mod vendor\n");
				break;
			case "composer.json":
				project.CreateFile("vendor/autoload.php", "<?php // generated by Composer\n");
				break;
			case "Gemfile":
				project.CreateFile("tmp/CACHEDIR.TAG", "Signature: 8a477f597d28d172789f06886806bc55\n");
				break;
		}
	}
